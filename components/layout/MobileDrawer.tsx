...
export function MobileDrawer({
  ...
  return (
    <Sheet onOpenChange={onOpenChange} open={open}>
      <SheetContent
        className="flex w-[88vw] max-w-[320px] flex-col border-[#E4E4E4] bg-white p-0 text-[#111111]"
        side="left"
        showCloseButton={false}
      >
        <SheetTitle className="sr-only">{COPY.sidebar.title}</SheetTitle>
        <div className="flex shrink-0 items-center justify-end border-b border-[#E4E4E4] px-4 py-2">
          <Button
